...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-08--09-21-52_付玉光___feat_引入了MANAGE_EXTERNAL_STORAGE权限
taskTypeIndex=
createBranchFlag=_
productManager=周立新
tester=
...
mateDataCreateTaskHourMinuteSecond=09-21-52
renamedFeatureBranchName=
createTaskTime=2023-11-08/09-22-01
...
developer=付玉光
taskName=引入了MANAGE_EXTERNAL_STORAGE权限
taskDescriptionFile=引入了MANAGE_EXTERNAL_STORAGE权限.md
branchName=feature/feature_fyg_9.1.18_引入了MANAGE_EXTERNAL_STORAGE权限
