...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-10--17-14-30_付玉光___fix_已安装APK的resources.arsc未压缩存储并在4字节边界上对齐
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=赵亚彬
taskName=已安装APK的resources.arsc未压缩存储并在4字节边界上对齐
...
mateDataCreateTaskHourMinuteSecond=17-14-30
branchName=feature/feature_fyg_9.1.18_已安装APK的resources.arsc未压缩存储并在4字节边界上对齐
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-10/17-14-47
...
taskDescriptionFile=已安装APK的resources.arsc未压缩存储并在4字节边界上对齐.md
#项目元数据目录
...
finishTaskTimeStamp=1699846018
