...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-46-09_付玉光___feat_受限制非SDK接口更新
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=受限制非SDK接口更新
...
mateDataCreateTaskHourMinuteSecond=17-46-09
branchName=feature/feature_fyg_9.1.18_受限制非SDK接口更新
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-03/17-46-12
...
taskDescriptionFile=受限制非SDK接口更新.md
#项目元数据目录
...
finishTaskTimeStamp=1699432024
