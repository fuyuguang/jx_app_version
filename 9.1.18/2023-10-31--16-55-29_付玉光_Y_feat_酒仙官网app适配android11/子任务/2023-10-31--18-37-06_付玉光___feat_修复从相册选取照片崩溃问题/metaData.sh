...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-10-31--18-37-06_付玉光___feat_修复从相册选取照片崩溃问题
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=修复从相册选取照片崩溃问题
...
mateDataCreateTaskHourMinuteSecond=18-37-06
branchName=feature/feature_fyg_9.1.18_修复从相册选取照片崩溃问题
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-10-31/18-37-10
...
taskDescriptionFile=修复从相册选取照片崩溃问题.md
#项目元数据目录
