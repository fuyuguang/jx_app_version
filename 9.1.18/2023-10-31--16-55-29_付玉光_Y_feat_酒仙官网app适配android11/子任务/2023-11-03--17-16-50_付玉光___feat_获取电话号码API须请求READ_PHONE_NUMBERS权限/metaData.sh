...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-16-50_付玉光___feat_获取电话号码API须请求READ_PHONE_NUMBERS权限
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=获取电话号码API须请求READ_PHONE_NUMBERS权限
...
mateDataCreateDate=2023-11-03
mateDataCreateTaskHourMinuteSecond=17-16-50
branchName=feature/feature_fyg_9.1.18_获取电话号码API须请求READ_PHONE_NUMBERS权限
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-03/17-16-53
...
taskDescriptionFile=获取电话号码API须请求READ_PHONE_NUMBERS权限.md
#项目元数据目录
...
finishTaskTimeStamp=1699431962
