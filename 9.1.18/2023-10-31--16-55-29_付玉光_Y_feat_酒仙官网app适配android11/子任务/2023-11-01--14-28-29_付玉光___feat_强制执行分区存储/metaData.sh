...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-01--14-28-29_付玉光___feat_强制执行分区存储
taskTypeIndex=
createBranchFlag=_
productManager=周立新
tester=
...
mateDataCreateDate=2023-11-01
mateDataCreateTaskHourMinuteSecond=14-28-29
renamedFeatureBranchName=
createTaskTime=2023-11-01/14-28-36
...
developer=付玉光
taskName=强制执行分区存储
taskDescriptionFile=强制执行分区存储.md
branchName=feature/feature_fyg_9.1.18_强制执行分区存储
preReleaseBranchName=feature/feature_preRelease_9.1.18
finishTaskTimeStamp=1699431893
