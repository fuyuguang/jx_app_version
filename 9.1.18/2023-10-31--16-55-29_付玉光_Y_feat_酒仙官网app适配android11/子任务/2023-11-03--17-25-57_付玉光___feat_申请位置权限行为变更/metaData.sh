...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-25-57_付玉光___feat_申请位置权限行为变更
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
...
mateDataCreateTaskHourMinuteSecond=17-25-57
branchName=feature/feature_fyg_9.1.18_申请位置权限行为变更
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-03/17-26-08
...
taskDescriptionFile=申请位置权限行为变更.md
#项目元数据目录
