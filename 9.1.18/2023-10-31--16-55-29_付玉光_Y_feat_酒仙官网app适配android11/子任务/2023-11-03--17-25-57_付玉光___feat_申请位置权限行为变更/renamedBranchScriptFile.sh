...
if [ -d "${workDir}/子任务" ]; then
      ...
      if [ -n "$(ls -A "${workDir}/子任务")" ]; then
              ...
              while read -r subTaskMetaDataFileItem; do
                  ...
                  #新的工作目录=新的/Users/fuyuguang/jiuxian_studio/doc/1版本/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-25-57_付玉光___feat_申请位置权限行为变更/子任务 + 子任务工作目录名
