...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-08--18-43-05_付玉光___feat_apk下载目录变更升级后删除对应的app安装包优化存储空间
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=apk下载目录变更升级后删除对应的app安装包优化存储空间
...
mateDataCreateTaskHourMinuteSecond=18-43-05
branchName=feature/feature_fyg_9.1.18_apk下载目录变更升级后删除对应的app安装包优化存储空间
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-08/18-43-11
...
taskDescriptionFile=apk下载目录变更升级后删除对应的app安装包优化存储空间.md
#项目元数据目录
...
finishTaskTimeStamp=1699432034
