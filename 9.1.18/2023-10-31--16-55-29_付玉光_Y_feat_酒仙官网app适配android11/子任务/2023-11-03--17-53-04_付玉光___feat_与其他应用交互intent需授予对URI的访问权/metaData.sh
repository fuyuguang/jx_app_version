...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-53-04_付玉光___feat_与其他应用交互intent需授予对URI的访问权
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=与其他应用交互intent需授予对URI的访问权
...
mateDataCreateTaskHourMinuteSecond=17-53-04
branchName=feature/feature_fyg_9.1.18_与其他应用交互intent需授予对URI的访问权
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-03/17-53-06
...
taskDescriptionFile=与其他应用交互intent需授予对URI的访问权.md
#项目元数据目录
...
finishTaskTimeStamp=1699514188
