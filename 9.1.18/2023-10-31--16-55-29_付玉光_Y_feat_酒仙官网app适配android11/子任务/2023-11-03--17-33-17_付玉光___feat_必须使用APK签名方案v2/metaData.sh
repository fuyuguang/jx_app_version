...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-03--17-33-17_付玉光___feat_必须使用APK签名方案v2
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=必须使用APK签名方案v2
...
mateDataCreateTaskHourMinuteSecond=17-33-17
branchName=feature/feature_fyg_9.1.18_必须使用APK签名方案v2
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-03/17-33-19
...
taskDescriptionFile=必须使用APK签名方案v2.md
#项目元数据目录
...
finishTaskTimeStamp=1699431997
changeScope=
taskDesc=
