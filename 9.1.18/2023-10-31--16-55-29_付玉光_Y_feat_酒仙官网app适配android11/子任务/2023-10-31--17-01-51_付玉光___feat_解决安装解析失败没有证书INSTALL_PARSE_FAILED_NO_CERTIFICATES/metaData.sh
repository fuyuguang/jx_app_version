...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-10-31--17-01-51_付玉光___feat_解决安装解析失败没有证书INSTALL_PARSE_FAILED_NO_CERTIFICATES
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=解决安装解析失败没有证书INSTALL_PARSE_FAILED_NO_CERTIFICATES
...
mateDataCreateTaskHourMinuteSecond=17-01-51
branchName=feature/feature_fyg_9.1.18_解决安装解析失败没有证书INSTALL_PARSE_FAILED_NO_CERTIFICATES
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-10-31/17-01-58
...
taskDescriptionFile=解决安装解析失败没有证书INSTALL_PARSE_FAILED_NO_CERTIFICATES.md
#项目元数据目录
...
finishTaskTimeStamp=1699431904
changeScope=安装apk时
