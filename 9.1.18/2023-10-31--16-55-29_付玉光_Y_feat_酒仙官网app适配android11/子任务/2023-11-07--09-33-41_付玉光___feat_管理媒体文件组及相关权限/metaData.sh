...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-55-29_付玉光_Y_feat_酒仙官网app适配android11/子任务/2023-11-07--09-33-41_付玉光___feat_管理媒体文件组及相关权限
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=管理媒体文件组及相关权限
...
mateDataCreateTaskHourMinuteSecond=09-33-41
branchName=feature/feature_fyg_9.1.18_管理媒体文件组及相关权限
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-07/09-33-50
...
taskDescriptionFile=管理媒体文件组及相关权限.md
#项目元数据目录
