...
developer=付玉光
tester=
taskName=TextView去掉默认的上下padding
branchVersion=9.1.18
mateDataCreateDate=2023-12-20
mateDataCreateTaskHourMinuteSecond=14-58-22
workDir=/酒仙官网app/9.1.18/TextView去掉默认的上下padding
branchName=feature/feature_fyg_9.1.18_TextView去掉默认的上下padding
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-12-20/14-58-24
...
taskDescriptionFile=TextView去掉默认的上下padding.md
#开发人员名单
