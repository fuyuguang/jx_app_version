...
workDir=/酒仙官网app/9.1.18/2023-11-10--16-17-55_付玉光___feat_电脑调试手机APP应用里的webView
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=电脑调试手机APP应用里的webView
...
mateDataCreateTaskHourMinuteSecond=16-17-55
branchName=feature/feature_fyg_9.1.18_电脑调试手机APP应用里的webView
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-10/16-17-56
...
taskDescriptionFile=电脑调试手机APP应用里的webView.md
#项目元数据目录
