...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10/子任务/2023-11-07--11-03-32_付玉光___feat_获取外部存储卷分配的唯一名称
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=获取外部存储卷分配的唯一名称
...
mateDataCreateTaskHourMinuteSecond=11-03-32
branchName=feature/feature_fyg_9.1.18_获取外部存储卷分配的唯一名称
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-07/11-03-38
...
taskDescriptionFile=获取外部存储卷分配的唯一名称.md
#项目元数据目录
