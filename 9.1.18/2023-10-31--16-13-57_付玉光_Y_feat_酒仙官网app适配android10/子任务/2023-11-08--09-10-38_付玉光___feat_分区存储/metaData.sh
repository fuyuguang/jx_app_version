...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10/子任务/2023-11-08--09-10-38_付玉光___feat_分区存储
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
...
mateDataCreateTaskHourMinuteSecond=09-10-38
branchName=feature/feature_fyg_9.1.18_分区存储
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-08/09-10-43
...
finishTaskTimeStamp=1699431841

subTaskCount=2

changeScope=但经测试具有读写权限时也可正常往sd卡中读写图片数据
taskDesc=此类应用只能访问外部存储空间上的应用专属目录，以及本应用所创建的特定类型的媒体文件
