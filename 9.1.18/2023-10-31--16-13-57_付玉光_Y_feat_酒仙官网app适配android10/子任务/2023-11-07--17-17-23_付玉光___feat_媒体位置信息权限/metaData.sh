...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10/子任务/2023-11-07--17-17-23_付玉光___feat_媒体位置信息权限
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
...
mateDataCreateDate=2023-11-07
mateDataCreateTaskHourMinuteSecond=17-17-23
branchName=feature/feature_fyg_9.1.18_媒体位置信息权限
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-07/17-17-26
...
taskDescriptionFile=媒体位置信息权限.md
#项目元数据目录
...
finishTaskTimeStamp=1699431856
changeScope=
taskDesc=
