...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10/子任务/2023-11-07--11-26-32_付玉光___feat_更新其他应用的媒体文件
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=更新其他应用的媒体文件
...
mateDataCreateTaskHourMinuteSecond=11-26-32
branchName=feature/feature_fyg_9.1.18_更新其他应用的媒体文件
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-07/11-26-38
...
taskDescriptionFile=更新其他应用的媒体文件.md
#项目元数据目录
