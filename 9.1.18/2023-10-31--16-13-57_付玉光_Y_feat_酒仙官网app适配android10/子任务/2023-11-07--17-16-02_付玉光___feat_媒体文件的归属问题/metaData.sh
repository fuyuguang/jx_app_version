...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10/子任务/2023-11-07--17-16-02_付玉光___feat_媒体文件的归属问题
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
...
mateDataCreateTaskHourMinuteSecond=17-16-02
branchName=feature/feature_fyg_9.1.18_媒体文件的归属问题
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-07/17-16-05
...
taskDescriptionFile=媒体文件的归属问题.md
#项目元数据目录
