...
workDir=/酒仙官网app/9.1.18/2023-10-31--16-13-57_付玉光_Y_feat_酒仙官网app适配android10
taskTypeIndex=
createBranchFlag=Y
productManager=周立新
developer=付玉光
tester=
taskName=酒仙官网app适配android10
...
mateDataCreateTaskHourMinuteSecond=16-13-57
branchName=feature/feature_fyg_9.1.18_酒仙官网app适配android10
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-10-31/16-13-59
...
taskDescriptionFile=酒仙官网app适配android10.md
#项目元数据目录
...
finishTaskTimeStamp=1699432684
