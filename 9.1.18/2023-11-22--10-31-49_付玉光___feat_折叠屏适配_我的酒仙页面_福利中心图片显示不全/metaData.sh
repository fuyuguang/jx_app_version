...
workDir=/酒仙官网app/9.1.18/2023-11-22--10-31-49_付玉光___feat_折叠屏适配_我的酒仙页面_福利中心图片显示不全
taskTypeIndex=
createBranchFlag=_
productManager=周立新
developer=付玉光
tester=
taskName=折叠屏适配_我的酒仙页面_福利中心图片显示不全
...
mateDataCreateDate=2023-11-22
mateDataCreateTaskHourMinuteSecond=10-31-49
branchName=feature/feature_fyg_9.1.18_折叠屏适配_我的酒仙页面_福利中心图片显示不全
preReleaseBranchName=feature/feature_preRelease_9.1.18
renamedFeatureBranchName=
createTaskTime=2023-11-22/10-31-51
...
taskDescriptionFile=折叠屏适配_我的酒仙页面_福利中心图片显示不全.md
#项目元数据目录
