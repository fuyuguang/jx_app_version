...
developer=付玉光
tester=
taskName=工业和信息化部通报存在问题的APP（SDK）名单
branchVersion=9.1.20
mateDataCreateDate=2024-02-03
mateDataCreateTaskHourMinuteSecond=11-02-23
workDir=/酒仙官网app/9.1.20/工业和信息化部通报存在问题的APP（SDK）名单
branchName=feature/feature_fyg_9.1.20_工业和信息化部通报存在问题的APP（SDK）名单
preReleaseBranchName=feature/feature_preRelease_9.1.20
renamedFeatureBranchName=
createTaskTime=2024-02-03/11-02-24
...
taskDescriptionFile=工业和信息化部通报存在问题的APP（SDK）名单.md
#开发人员名单
