...
if [ -d "${workDir}/子任务" ]; then
      ...
      if [ -n "$(ls -A "${workDir}/子任务")" ]; then
              ...
              while read -r subTaskMetaDataFileItem; do
                  ...
                  #新的工作目录=新的/Users/fuyuguang/jiuxian_studio/doc/1版本/酒仙官网app/9.1.20/2023-11-28--16-57-12_付玉光___feat_四大分卫/子任务/2023-11-28--17-40-54_付玉光___feat_无法卧榻/子任务/2023-11-28--17-41-27_付玉光___feat_砍砍价/子任务 + 子任务工作目录名
