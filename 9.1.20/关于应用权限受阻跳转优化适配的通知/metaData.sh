...
developer=付玉光
tester=
taskName=关于应用权限受阻跳转优化适配的通知
branchVersion=9.1.20
mateDataCreateDate=2024-02-03
mateDataCreateTaskHourMinuteSecond=11-03-54
workDir=/酒仙官网app/9.1.20/关于应用权限受阻跳转优化适配的通知
branchName=feature/feature_fyg_9.1.20_关于应用权限受阻跳转优化适配的通知
preReleaseBranchName=feature/feature_preRelease_9.1.20
renamedFeatureBranchName=
createTaskTime=2024-02-03/11-03-55
...
taskDescriptionFile=关于应用权限受阻跳转优化适配的通知.md
#开发人员名单
