...
developer=付玉光
tester=
taskName=华为应用市场检测出app存在无响应功能问题
branchVersion=9.1.20
mateDataCreateDate=2024-02-23
mateDataCreateTaskHourMinuteSecond=16-26-23
workDir=/酒仙官网app/9.1.20/华为应用市场检测出app存在无响应功能问题
branchName=feature/feature_fyg_9.1.20_华为应用市场检测出app存在无响应功能问题
preReleaseBranchName=feature/feature_preRelease_9.1.20
renamedFeatureBranchName=
createTaskTime=2024-02-23/16-26-24
...
taskDescriptionFile=华为应用市场检测出app存在无响应功能问题.md
#开发人员名单
