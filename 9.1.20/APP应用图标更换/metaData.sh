...
finishTaskTimeStamp=1708249796
projectName=酒仙官网app
...
mateDataCreateDate=2024-02-18
mateDataCreateTaskHourMinuteSecond=15-04-45
workDir=/酒仙官网app/9.1.20/APP应用图标更换
branchName=feature/feature_fyg_9.1.20_APP应用图标更换
preReleaseBranchName=feature/feature_preRelease_9.1.20
renamedFeatureBranchName=
createTaskTime=2024-02-18/15-04-46
...
taskDescriptionFile=APP应用图标更换.md
#开发人员名单
