...
finishTaskTimeStamp=1703231230
projectName=酒仙官网app
...
mateDataCreateTaskHourMinuteSecond=10-56-55
workDir=/酒仙官网app/9.1.19/更换年货节启动图标
branchName=feature/feature_fyg_9.1.19_更换年货节启动图标
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2023-12-22/10-56-56
...
taskDescriptionFile=更换年货节启动图标.md
#开发人员名单
