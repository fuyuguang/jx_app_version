...
developer=付玉光
tester=
taskName=侵害用户权益行为的SDK通报
branchVersion=9.1.19
mateDataCreateDate=2023-12-27
mateDataCreateTaskHourMinuteSecond=09-19-26
workDir=/酒仙官网app/9.1.19/侵害用户权益行为的SDK通报
branchName=feature/feature_fyg_9.1.19_侵害用户权益行为的SDK通报
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2023-12-27/09-19-27
...
taskDescriptionFile=侵害用户权益行为的SDK通报.md
#开发人员名单
