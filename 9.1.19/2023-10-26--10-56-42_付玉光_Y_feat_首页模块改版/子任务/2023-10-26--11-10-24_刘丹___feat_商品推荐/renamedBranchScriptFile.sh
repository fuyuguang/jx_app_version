...
if [ -d "${workDir}/子任务" ]; then
      ...
      if [ -n "$(ls -A "${workDir}/子任务")" ]; then
              ...
              while read -r subTaskMetaDataFileItem; do
                  ...
                  #新的工作目录=新的/Users/fuyuguang/jiuxian_studio/doc/1版本/酒仙官网app/9.1.19/2023-10-26--10-56-42_付玉光_Y_feat_首页模块改版/子任务/2023-10-26--11-10-24_刘丹___feat_商品推荐/子任务 + 子任务工作目录名
