...
projectName=酒仙官网app
productManager=周立新
workDir=/酒仙官网app/9.1.19/2023-10-26--10-56-42_付玉光_Y_feat_首页模块改版
developer=付玉光
taskName=首页模块改版
...
mateDataCreateTaskHourMinuteSecond=10-56-42
branchName=feature/feature_fyg_9.1.19_首页模块改版
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2023-10-26/10-56-42
...
finishTaskTimeStamp=1698289580
finishTaskTime=2023-10-26/11-47-16
subTaskCount=2
taskRowspan=3
