...
finishTaskTimeStamp=1703231237
projectName=酒仙官网app
...
developer=付玉光
tester=赵亚彬
taskName=我的酒仙页面_福利中心图片截断显示不全问题
branchVersion=9.1.19
mateDataCreateDate=2023-12-22
mateDataCreateTaskHourMinuteSecond=11-27-16
workDir=/酒仙官网app/9.1.19/我的酒仙页面_福利中心图片截断显示不全问题
branchName=feature/feature_fyg_9.1.19_我的酒仙页面_福利中心图片截断显示不全问题
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2023-12-22/11-27-17
...
taskDescriptionFile=我的酒仙页面_福利中心图片截断显示不全问题.md
#开发人员名单
