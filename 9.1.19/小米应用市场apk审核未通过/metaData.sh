...
developer=付玉光
tester=
taskName=小米应用市场apk审核未通过
branchVersion=9.1.19
mateDataCreateDate=2024-01-11
mateDataCreateTaskHourMinuteSecond=17-02-50
workDir=/酒仙官网app/9.1.19/小米应用市场apk审核未通过
branchName=feature/feature_fyg_9.1.19_小米应用市场apk审核未通过
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2024-01-11/17-02-52
...
taskDescriptionFile=小米应用市场apk审核未通过.md
#开发人员名单
