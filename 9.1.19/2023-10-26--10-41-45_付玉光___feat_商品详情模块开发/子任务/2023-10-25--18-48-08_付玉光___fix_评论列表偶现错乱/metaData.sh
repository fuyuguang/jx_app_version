...
projectName=酒仙官网app
productManager=周立新
workDir=/酒仙官网app/9.1.19/2023-10-26--10-41-45_付玉光___feat_商品详情模块开发/子任务/2023-10-25--18-48-08_付玉光___fix_评论列表偶现错乱
developer=付玉光
taskName=评论列表偶现错乱
...
mateDataCreateTaskHourMinuteSecond=18-48-08
branchName=feature/feature_fyg_9.1.19_评论列表偶现错乱
preReleaseBranchName=feature/feature_preRelease_9.1.19
renamedFeatureBranchName=
createTaskTime=2023-10-25/18-48-08
...
#markdown文件名
taskDescriptionFile=评论列表偶现错乱.md
#任务层级文件
...
finishTaskTimeStamp=1698291484
